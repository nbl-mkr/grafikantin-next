        ...
        <div className="mx-auto w-full max-w-sm py-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="space-y-1.5">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full rounded-xl border border-gray-200 bg-white py-3 pl-4 pr-11 text-sm text-gray-900 placeholder-gray-400 focus:border-[#3333cc] focus:outline-none focus:ring-1 focus:ring-[#3333cc] shadow-sm transition"
                />
            ...
            <button
              ...
              className="w-full rounded-xl bg-[#3333cc] py-3 text-sm font-semibold text-white shadow-md hover:bg-[#2b2bad] transition active:scale-[0.98]"
            >
              Masuk
            </button>
          </form>
