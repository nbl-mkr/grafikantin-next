export default function ValueCards() {
  return (
    <section className="w-full bg-[#3333cc] py-14 md:py-20 text-white">
      <div className="mx-auto max-w-6xl px-6">
        <div className="mb-12 text-center max-w-xl mx-auto">
          ...
          <p className="mt-2 text-sm sm:text-base text-indigo-100/80">
          ...
          <div className="group relative flex flex-col justify-between rounded-2xl bg-white p-7 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-xl">
            <div>
              <div className="flex items-center justify-between mb-5">
                <div className="flex size-12 items-center justify-center rounded-xl bg-[#3333cc]/10 group-hover:bg-[#3333cc] transition-colors duration-300">
                  <svg className="size-6 text-[#3333cc] group-hover:text-white transition-colors duration-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                  </svg>
                </div>
                <span className="text-2xl font-black text-gray-200 group-hover:text-[#3333cc]/20 transition-colors">
                  01
                </span>
              </div>

              <h3 className="text-lg font-bold text-gray-900 group-hover:text-[#3333cc] transition-colors">
            ...
            <div className="mt-6 h-1 w-8 rounded-full bg-gray-100 group-hover:w-full group-hover:bg-[#3333cc] transition-all duration-300" />
          </div>
