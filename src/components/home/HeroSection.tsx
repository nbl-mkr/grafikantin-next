      ...
      <div className="relative mx-auto flex max-w-6xl flex-col items-center justify-between gap-12 px-6 md:flex-row">
        <div className="w-full text-center md:text-left md:w-1/2">
          ...
          <div className="mt-8 flex justify-center md:justify-start">
            <a
              href="/order"
              className="inline-flex items-center justify-center gap-2 rounded-lg bg-[#e76f51] px-7 py-3.5 text-sm font-semibold text-white shadow-lg shadow-[#E76F51]/25 transition-all duration-200 hover:opacity-90 hover:shadow-[#E76F51]/35 active:scale-[0.98]"
            >
